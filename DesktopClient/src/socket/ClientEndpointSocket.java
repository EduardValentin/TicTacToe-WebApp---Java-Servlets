...
public class ClientEndpointSocket {
    ...
    public void onMessage(String message) {
        ...
        // Messages are of the following form ACTION|NUMBER*|FROM|TO*, where:
        // - ACTION is one of the following: JOIN,WON,MOVE
        // - FROM is the username of the player that sent the message
        // - TO is the reciever of the message
